...
This should be used if you are looking to retrain KlangScribe using a different data modeling configuration. By default, KlangScribe uses the following data model configuration template (also located [here](/configs/templates/data_model.yaml)):
```
TBD; not yet defined
```
